...
use OstStores\Models\Holiday;

class Shopware_Controllers_Backend_OstStoresHoliday extends Shopware_Controllers_Backend_Application
{
    /**
     * ...
     *
