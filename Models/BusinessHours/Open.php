 ...
 * @ORM\Table(name="ost_stores_businesshours_open")
 */
class Open extends ModelEntity
{
    /**
     * Auto-generated id.
     *
     ...
     * @var Store
     *
     * @ORM\ManyToOne(targetEntity="OstStores\Models\Store", inversedBy="businesshoursOpen")
